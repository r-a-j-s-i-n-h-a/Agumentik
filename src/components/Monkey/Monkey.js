  ...
  return (
    <>
      <div className="deliver">
        <h2 className="hed">
          <span className="spann">Deliver your best work</span> with monday.com{" "}
        </h2>
        <h3 className="jj">
          No credit card needed ✦ Unlimited time on Free plan
        </h3>
        <button className="bh"> Get Started</button>
      </div>
      <div className="bodyy">
        <footer class="footer">
          <div class="footer__addr">
            <h1 class="footer__logo">
              <img src="https://dapulse-res.cloudinary.com/image/upload/f_auto,q_auto/remote_mondaycom_static/img/monday-logo-x2.png"></img>
            </h1>
